void GENERATE_GROUND_TRUTH(TokenContainer &tokens)
{
    ...
    // Import statement
    tokens.Append(Token(TOKEN_KEYWORD, str="#import", l=3, bc=1));
    ...
    tokens.Append(Token(TOKEN_KEYWORD, str="fn", l=5, bc=6));
    tokens.Append(Token(TOKEN_PART, c='(', l=5, bc=8));
        ...
        tokens.Append(Token(TOKEN_KEYWORD, str="int", l=5, bc=11));
    tokens.Append(Token(TOKEN_PART, c=')', l=5, bc=14));
    tokens.Append(Token(TOKEN_KEYWORD, str="int", l=5, bc=15));
    tokens.Append(Token(TOKEN_PART, c='{', l=5, bc=19));
        // if statement
        tokens.Append(Token(TOKEN_KEYWORD, str="if", l=6, bc=3));
        ...
        tokens.Append(Token(TOKEN_KEYWORD, str="return", l=7, bc=5));
        ...
        tokens.Append(Token(TOKEN_KEYWORD, str="return", l=8, bc=3));
    ...
    tokens.Append(Token(TOKEN_KEYWORD, str="fn", l=10, bc=7));
    tokens.Append(Token(TOKEN_PART, c='(', l=10, bc=9));
    tokens.Append(Token(TOKEN_PART, c=')', l=10, bc=10));
    tokens.Append(Token(TOKEN_KEYWORD, str="int", l=10, bc=11));
